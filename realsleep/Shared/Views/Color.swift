...
extension Color {
    static let mainLighest = Color(hex: "777777")
    static let mainLighter = Color(hex: "565656")
    static let mainLight = Color(hex: "333333")
    static let neuBackground = Color(hex: "f0f0f3")
    static let neuBackgroundPressed = Color(hex: "ffffff")
